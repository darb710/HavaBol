...
public class Token 
{
    ...
    /***
     * Constructor method for our Token class.
     * <p>
     * Simply assigns the string/token passed to the constructor to tokenStr variable.
     * Token attributes will be handled and modified by Scanner
     * @param value		String that will be the Token for Interpreter
     */
    ...
    /***
     * Method invokes other constructor with empty string
     */
